...
let jobs = Object.entries({
  1: {
    ...
    description:
      "Se busca zapatero para trabajar los sabados este mes de agosto...",
    date: "04/10/2021",
    salary: "45.000",
  ...
  2: {
    ...
    title: "Aseadora",
    description:
      "Busco una mujer para que me haga el aseo general en mi casa...",
    date: "26/10/2021",
    salary: "35.000",
    location: "Medellín, Antioquia",
                  ...
                  <div className="row">
                    <div className="col">
                      <div className="description">
                        <div className="descriptionTitle colorTextTheme">
                          Descripción:
                        </div>
                        <p className="colorTextTheme">{job[1].description}</p>
